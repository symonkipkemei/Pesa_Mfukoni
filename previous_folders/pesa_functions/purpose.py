def add_pesa_purpose_expenditure():
    ...
    while correct:
        print("\n*************\n"
              "Add expenditure purpose(y/n)")
        select = str.lower(input("your choice:"))

        with open("pesa_files/pesa_purpose_expenditure.csv", "r") as f:
        ...
        if select == str.lower("y"):
            ...
            with open("pesa_files/pesa_purpose_expenditure.csv", "a") as f:
                f.write(data)
...
def add_pesa_purpose_income():
    ...
    while correct:
        print("\n*************\n"
              "Add income purpose(y/n)")
        select = str.lower(input("your choice:"))

        with open("pesa_files/pesa_purpose_income.csv", "r") as f:
            iterable = csv.reader(f)
            dd_iterable = list(iterable)
            index_list = []
            purpose_list = []
        ...
        if select == str.lower("y"):
            ...
            # store data
            data = str(user_index) + "," + str(user_purpose) + "\n"
            with open("pesa_files/pesa_purpose_income.csv", "a") as f:
                f.write(data)
...
def pesa_purpose(feedback):
    ...
    if str.upper(feedback) == "EXPENDITURE":
        pesa_dict = {}
        with open("pesa_files/pesa_purpose_expenditure.csv", "r") as f:
            iterable = csv.reader(f)
    ...
    elif str.upper(feedback) == "INCOME":
        pesa_dict = {}
        try:
            with open("pesa_files/pesa_purpose_income.csv", "r") as f:
                iterable = csv.reader(f)
            ...
            file = open("pesa_files/pesa_purpose_income.csv", "w")
            file.close()
