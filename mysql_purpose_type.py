...
#note that change occurencies applies only to the columns of the selected table .For instance:
# purpose_type_id (table_id)
# purpose_type_description (table_entry description)


def purpose_type_table(table_name):
    ...
    while try_again:
        ...
        query = s.select([selected_table.columns.purpose_type_id, selected_table.columns.purpose_type_description])
        ...
        #_______________________________________________________________________________________
            ...
            if user_selection in changes.keys():
                ...
                if user_selection == str.lower("u"):
                    ...
                    update = s.update(selected_table).values(purpose_type_description=value_selection).where(selected_table.columns.purpose_type_id == id_selection)
                ...
                #DELETE
                    ...
                    delete = query = s.delete(selected_table).where(selected_table.columns.purpose_type_id == id_selection)
                ...
                # INSERT
                    ...
                    value_selection = input("New result type: ")
                    print("_____________________________")
                    insert = s.insert(selected_table).values(purpose_type_description =value_selection)
...
def show_purpose_type_table(table_name : str) -> int:
...
if __name__ == "__main__":
    selected_id = show_purpose_type_table("purpose_type")
    print(selected_id)